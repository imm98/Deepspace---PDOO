...
public class NamesCapture extends JDialog {
    ...
    public NamesCapture(MainView parent) {
        super(parent, true);            //Hacemos super para que se muestre el dialogo
        initComponents();
        setLocationRelativeTo (null);   //Centra la posicion de la vista
        setTitle (parent.getAppName());     //Obtiene el titulo del padre
    ...
    private void jbStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbStartActionPerformed
        ...
        //Es el botón de empezar y lo que hace es te establece el vector de nombres a vacio y Añade a nombres lo que haya escrito
        names.clear();
    ...
    ArrayList<String> getNames() {
        setVisible(true);       //Hacemos visble la vista
        return names;           //Le damos a empezar 
    }
