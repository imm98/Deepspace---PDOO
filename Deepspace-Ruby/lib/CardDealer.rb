...
class CardDealer 
    ...
    def initialize ()
        @suppliesPackages=CardDeck.new()    #El initialize de CardDeck te crea un arrayList vacio
    ...
    def initCards()                       #La función initCards te inicializa todo lo de abajo
    ...
    def createSuppliesPackages()                            #Te añade en el CardDeck "suppliesPackages" todos los SuppliesPackages siguientes
    ...
    def createEnemies() 
        ...
        transformLoot0=Loot.new(1,1,1,1,1,true,false)
